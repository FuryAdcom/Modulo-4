...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="well">
        <p>Por favor llene los datos a continuacion para agregar su compañia:</p>
            <div style="width:50%; float:left; height:60px">Nombre compañia:<br />
            <input type="text" placeholder="Nombre" name="companyname" style="height: 25px">
            </div>
            <div style="width:50%; float:left; height:60px">Acronimo:<br />
            <input type="text" placeholder="Acronimo" name="companyacronym" style="height: 25px">
            </div>
            <div style="width:50%; float:left; height:60px">RIF: <br />
            <select name="Tipo RIF"  style="float:left; height: 25px">
          <option value="J">J</option>
          <option value="">Ej2</option>
          <option value="">Ej3</option>
         </select> -
            <input type="text" placeholder="Ej:00000000-0" name="companyrif" style="height: 25px">
            </div>
        <div style="width:50%; float:left; height:60px">Pais: <br />
            <select name="Pais"  style="float:left; height: 25px">
...
<option value="Zimbabue" id="ZW">Zimbabue</option>
        ...
        <div style="width:100%; float:left; height:60px">Direccion:<br />
            <input type="text" placeholder="Direccion" name="companyaddress" style="height: 25px; width:80%">
            </div>
        <div style="width:50%; float:left; height:60px">Correo:<br />
